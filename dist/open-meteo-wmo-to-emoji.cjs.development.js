...
function openWeatherWMOToEmoji(weatherCode, daylite) {
  if (weatherCode === void 0) {
    weatherCode = -1;
  }
  if (daylite === void 0) {
    daylite = true;
...
exports.openWeatherWMOToEmoji = openWeatherWMOToEmoji;
//# sourceMappingURL=open-meteo-wmo-to-emoji.cjs.development.js.map
